import {
    ...
    import '../components/MantleNFT.css';
    import { parseIneligibility } from "../utils/parseIneligibility";
  
  // Put Your Edition Drop Contract address from the dashboard here
  const EditionDropContractAddress = "0x31Fd8c44a1869C48D054d8431Fb8F62C746494EF";
  
  // Put your token ID here
  const tokenId = 1;
  
export  const MantleNFT = () => {
    const address = useAddress();
    const [quantity, setQuantity] = useState(1);
    const { contract: editionDrop } = useContract(EditionDropContractAddress);
